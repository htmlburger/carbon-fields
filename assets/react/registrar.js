...
import DateField from 'fields/components/date';
...
import TimeField from 'fields/components/time';
...
registerFieldComponent('Date', DateField);
registerFieldComponent('DateTime', TimeField);
...
registerFieldComponent('Time', TimeField);
