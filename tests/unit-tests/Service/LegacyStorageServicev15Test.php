...
class LegacyStorageServicev15Test extends WP_UnitTestCase {
	...
	public function testGetStorageArrayForDatastoreReturnsResultsForAllFields() {
		...
		$expected = array(
			'_crb_legacy_text' => 'lorem ipsum',
			'_crb_legacy_text||0|0|value' => 'lorem ipsum',
			'_crb_legacy_map||0|0|value' => '19.0759837,72.87765590000004',
			...
			'_crb_home_sections|columns:rows:cols:link|0:0:0:1|0|value' => 'http://example.com/some-internal-path/some-file.php?some_query_arg=some_value',
	...
	public function testGetStorageArrayReturnsSingleFieldValue() {
		...
		$expected = array(
			...
			(object) array(
				'key' => '_crb_legacy_text||0|0|value',
				'value' => 'lorem ipsum',
			),
		);
