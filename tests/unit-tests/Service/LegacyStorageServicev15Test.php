...
class LegacyStorageServicev15Test extends WP_UnitTestCase {
	...
	public function setUp() {
		...
		$this->legacy_storage_array = array(
			...
			'_crb_home_sections_features-_columns_0_col3of4-_rows_0_row-_cols_0_col2of3-_link_1' => 'http://example.com/some-internal-path/some-file.php?some_query_arg=some_value',
	...
	public function testGetStorageArrayForDatastoreReturnsResultsForAllFields() {
		...
		$expected = array(
			...
			'_crb_home_sections|columns:rows:cols|0:0:0|0|_value' => 'col1of3',
			'_crb_home_sections|columns:rows:cols:map|0:0:0:0|0|_value' => '40.7127837,-74.0059413',
			...
			'_crb_home_sections|columns:rows:cols:set|0:0:0:0|0|_value' => 'one',
			'_crb_home_sections|columns:rows:cols:set|0:0:0:0|1|_value' => 'three',
			'_crb_home_sections|columns:rows:cols:association|0:0:0:0|0|_value' => 'post:post:47',
			'_crb_home_sections|columns:rows:cols:image|0:0:0:0|0|_value' => '',
			'_crb_home_sections|columns:rows:cols:link|0:0:0:0|0|_value' => 'lorem ipsum',

			'_crb_home_sections|columns:rows:cols|0:0:0|1|_value' => 'col2of3',
			'_crb_home_sections|columns:rows:cols:image|0:0:0:1|0|_value' => '65',
			'_crb_home_sections|columns:rows:cols:link|0:0:0:1|0|_value' => 'http://example.com/some-internal-path/some-file.php?some_query_arg=some_value',
			'_crb_home_sections|columns:rows:cols:light|0:0:0:1|0|_value' => '',
			'_crb_home_sections|columns:rows:cols:content|0:0:0:1|0|_value' => '<h3><strong>Regular</strong> Sofas</h3>[button link="#"]More Details[/button]',
		);
